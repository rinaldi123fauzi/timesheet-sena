    ...
    series: [
      {
        name: 'Orders',
        data: [
          32, 66, 44, 55, 41, 24, 67, 22, 43, 32, 66, 44, 55, 41, 24, 67, 22, 43
        ]
      },
      {
        name: 'Visitors',
  ...
  lineChartoptions = {
    series: [
      ...
      },
      {
        name: 'Visitors',
        data: [
          11, 45, 20, 32, 34, 52, 41, 11, 32, 45, 11, 75, 20, 32, 34, 52, 41, 81
        ]
      },
      {
        name: 'Orders',
...
var radarChartWidget,
  radarChartWidgetOptions = {
    ...
    yaxis: {
      labels: {
        style: { colors: colors.mutedColor, fontFamily: base.defaultFontFamily }
      }
    },
    xaxis: {
      categories: ['01', '02', '03', '04', '05', '06'],
      labels: {
        title: { colors: colors.mutedColor, fontFamily: base.defaultFontFamily }
      }
    },
    grid: {
      borderColor: colors.borderColor,
  ...
  areaChartWidgetOptions = {
    series: [
      ...
      },
      {
        name: 'Mobile Apps',
        data: [
          11, 45, 20, 32, 34, 52, 41, 11, 32, 45, 11, 75, 20, 32, 34, 52, 41, 50
        ]
      },
      {
        name: 'Others',
...
heatmapchartCtn &&
  (heatmapchart = new ApexCharts(heatmapchartCtn, heatmapChartOptions)).render()
var bubblechart,
  bubbleChartOptions = {
    series: [
      {
