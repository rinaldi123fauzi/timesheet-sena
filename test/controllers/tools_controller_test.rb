...
class ToolsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tool" do
    assert_difference('Tool.count') do
      post tools_url, params: { tool: { kategori: @tool.kategori, nama: @tool.nama, nomor_serial: @tool.nomor_serial, sifat: @tool.sifat, vendor_id: @tool.vendor_id } }
    end
  ...
  test "should update tool" do
    patch tool_url(@tool), params: { tool: { kategori: @tool.kategori, nama: @tool.nama, nomor_serial: @tool.nomor_serial, sifat: @tool.sifat, vendor_id: @tool.vendor_id } }
