...
class ApprovalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create approval" do
    assert_difference('Approval.count') do
      post approvals_url, params: { approval: { approve_by: @approval.approve_by, approve_level: @approval.approve_level, date: @approval.date, loan_id: @approval.loan_id } }
    end
  ...
  test "should update approval" do
    patch approval_url(@approval), params: { approval: { approve_by: @approval.approve_by, approve_level: @approval.approve_level, date: @approval.date, loan_id: @approval.loan_id } }
