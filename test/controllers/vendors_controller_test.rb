...
class VendorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vendor" do
    assert_difference('Vendor.count') do
      post vendors_url, params: { vendor: { alamat: @vendor.alamat, kategori: @vendor.kategori, nama: @vendor.nama } }
    end
  ...
  test "should update vendor" do
    patch vendor_url(@vendor), params: { vendor: { alamat: @vendor.alamat, kategori: @vendor.kategori, nama: @vendor.nama } }
