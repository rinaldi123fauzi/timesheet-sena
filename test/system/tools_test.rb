...
class ToolsTest < ApplicationSystemTestCase
  ...
  test "creating a Tool" do
    ...
    fill_in "Kategori", with: @tool.kategori
    fill_in "Nama", with: @tool.nama
    fill_in "Nomor serial", with: @tool.nomor_serial
    fill_in "Sifat", with: @tool.sifat
    fill_in "Vendor", with: @tool.vendor_id
